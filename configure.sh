...
echo -e "${GREEN}📖 Reading configuration from config.yaml...${NC}"
echo ""
...
# ============================================
echo -e "${BLUE}═══════════════════════════════════════════════════════════════${NC}"
echo -e "${GREEN}📝 Updating fraud-case-management/app.yaml...${NC}"
echo -e "${BLUE}═══════════════════════════════════════════════════════════════${NC}"
echo ""

# Get OAuth secret from AWS Secrets Manager
echo "🔐 Retrieving OAuth secret from AWS Secrets Manager..."
...
if [ -z "$OAUTH_SECRET" ]; then
    echo -e "${YELLOW}⚠️  OAuth secret not found in AWS Secrets Manager${NC}"
...
if [ -z "$LAKEBASE_DNS" ]; then
    echo -e "${YELLOW}⚠️  Lakebase DNS not found in Terraform state${NC}"
...
# ============================================
echo -e "${BLUE}═══════════════════════════════════════════════════════════════${NC}"
echo -e "${GREEN}📝 Creating .env file for scripts...${NC}"
echo -e "${BLUE}═══════════════════════════════════════════════════════════════${NC}"
echo ""
...
echo "   ✅ fraud-case-management/app.yaml"
